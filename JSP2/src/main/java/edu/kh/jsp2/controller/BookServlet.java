...
public class BookServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		bookList.add(new Book("JS란 무엇인가", "이순신", 30000));
		bookList.add(new Book("CSS란 무엇인가", "짱구", 40000));
		bookList.add(new Book("Servlet란 무엇인가", "훈이", 50000));
		bookList.add(new Book("JSP란 무엇인가", "철수", 60000));
		bookList.add(new Book("Spring이란 무엇인가", "유리", 70000));
